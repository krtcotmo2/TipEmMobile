...
export default class Slider extends PureComponent {
  ...
  _renderThumbImage = () => {
    ...
    if (!thumbImage) return <Text style={{textAlign:'center', textAlignVertical:'center', height:30, backgroundColor:'gold', borderRadius:15}}>{this.props.value}</Text>;
    return <ImageBackground source={thumbImage} style={{width:30, height:30}}><Text style={{textAlign:'center', textAlignVertical:'center', height:30, fontSize:10}}>{this.props.value}</Text></ImageBackground>;
  };
}
